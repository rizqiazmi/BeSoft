...
if (!empty($_POST['input_order_validate'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tb_order (id_order, meja, pelanggan, catatan, pelayan, status) VALUES ('$kode_order', '$meja', '$pelanggan', '$catatan', '$_SESSION[id_besoft]', '')");
        if ($query) {
